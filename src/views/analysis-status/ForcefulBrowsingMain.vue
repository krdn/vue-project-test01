<template>
  ...
  >
    <CRow class="double-contents-header">
      <CCol :xxl="12" :xl="12" class="container">
        <span class="title">{{ $t('ForcefulBrowsing') }}</span>
    ...
    <CRow class="double-contents-body">
      <CCol>
        <BarChart
          ...
          :seriesItems="forcefulBrowsingStatus!.seriesItems"
          :chartData="forcefulBrowsingStatus!.data"
        ></BarChart>
      </CCol>
    </CRow>
    <CRow class="double-contents-header">
  ...
  >
    ...
    <AutoComplete
      ...
      width="250px"
      v-model="condition"
      :dataItems="searchCriteriaStore.getForcefulSearchCriterias"
    ></AutoComplete>
...
export default class ForcefulBrowsingMain extends Base {
  ...
  forcefulBrowsingStatus: TChart | null = null
  ...
  async created(): Promise<void> {
    ...
    this.searchCriterias.chart.type = ATTACK_TYPE.FORCEFUL_BROWSING
    ...
    this.searchCriterias.grid.type = ATTACK_TYPE.FORCEFUL_BROWSING
  ...
  async setChartData() {
    ...
    this.forcefulBrowsingStatus = data
  }
  ...
  saveButtonOnClick(e: Event) {
    this.searchCriteriaStore.pushForcefulSearchCriterias(this.condition)
  }
