<template>
  ...
  >
    <CRow class="double-contents-header">
      <CCol :xxl="12" :xl="12" class="container">
        <span class="title">{{ $t('SqlInjection') }}</span>
    ...
    <CRow class="double-contents-body">
      <CCol>
        <BarChart
          ...
          :seriesItems="sqlInjectionStatus!.seriesItems"
          :chartData="sqlInjectionStatus!.data"
        ></BarChart>
      </CCol>
    </CRow>
    <CRow class="double-contents-header">
  ...
  >
    ...
    <AutoComplete
      ...
      width="250px"
      v-model="condition"
      :dataItems="searchCriteriaStore.getSQLInjectionSearchCriterias"
    ></AutoComplete>
...
export default class SqlInjectionMain extends Base {
  ...
  sqlInjectionStatus: TChart | null = null
  ...
  async created(): Promise<void> {
    ...
    this.searchCriterias.chart.type = ATTACK_TYPE.SQL_INJECTION
    ...
    this.searchCriterias.grid.type = ATTACK_TYPE.SQL_INJECTION
  ...
  saveButtonOnClick(e: Event) {
    this.searchCriteriaStore.pushSQLInjectionSearchCriterias(this.condition)
  }

  gridOnReady(gridApi: GridApi, columnApi: ColumnApi, customApi: TDataGridCustomApi): void {
