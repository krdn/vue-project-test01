<template>
  ...
  >
    <CRow class="double-contents-header">
      <CCol :xxl="12" :xl="12" class="container">
        <span class="title">{{ $t('UnauthorizedAccess') }}</span>
    ...
    <CRow class="double-contents-body">
      <CCol>
        <BarChart
          ...
          :seriesItems="unauthorizedAccesStatus!.seriesItems"
          :chartData="unauthorizedAccesStatus!.data"
        ></BarChart>
      </CCol>
    </CRow>
    <CRow class="double-contents-header">
  ...
  >
    ...
    <AutoComplete
      ...
      width="250px"
      v-model="condition"
      :dataItems="searchCriteriaStore.getUnAuthorizedSearchCriterias"
    ></AutoComplete>
...
export default class UnauthorizedAccessMain extends Base {
  ...
  unauthorizedAccesStatus: TChart | null = null
  ...
  async created(): Promise<void> {
    ...
    this.searchCriterias.chart.type = ATTACK_TYPE.UNAUTHORIZED_ACCESS
    ...
    this.searchCriterias.grid.type = ATTACK_TYPE.UNAUTHORIZED_ACCESS
  ...
  async setChartData() {
    ...
    this.unauthorizedAccesStatus = data
  }
  ...
  saveButtonOnClick(e: Event) {
    this.searchCriteriaStore.pushUnAuthorizedSearchCriterias(this.condition)
  }
